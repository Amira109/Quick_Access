...
if (isset($_GET['deleted_id'])){
  ...
  $result = mysqli_query($con,"DELETE FROM books WHERE id='$id'") or die(mysql_error());
...
<form method="POST" action = "<?php $_PHP_SELF ?>">
  <div>
    <div>
      <div><br><h2 style="text-align: center;">Books</h2><br></div>
      <a href="AddBooks.php"><i style="font-weight: bold;"> add </i></a>
    </div>
    <div>
      <table id="customers">
        <tr>
        ...
        <tr>
          ...
          <td>           
            <a href="EditBooks.php?id=<?php echo $row["id"]; ?>"rel="tooltip" name="id"><i>edit</i></a>
            <a href="admin_books.php?deleted_id=<?php echo $row["id"]; ?>" onclick="return confirm('Are you sure?')" rel="tooltip" name="deleted_id" value="delete"><i>delete</i></a>  
          </td>                
        </tr>
